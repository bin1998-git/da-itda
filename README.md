...
inquiries           -- 1:1 문의
product_qna         -- 상품 Q&A (구매자 질문, 판매자 답변)
```
...
| 20 | 상품 Q&A — product_qna DB+RLS, 구매자 질문/판매자 인라인 답변, 답변 시 알림, 상품 상세 문의 탭 연결 | 2026-07-02 |
...
- [x] Phase 20: 상품 Q&A — 구매자 질문 + 판매자 인라인 답변, 답변 시 알림, 상품 상세 문의 탭 연결
  - ⚠️ 수동 작업 필요: `supabase/migrations/20260702000010_product_qna.sql`을 Supabase SQL Editor에서 실행해야 실제로 동작함 (실행 전까지는 문의 탭이 항상 "아직 등록된 문의가 없어요"로만 보임)
