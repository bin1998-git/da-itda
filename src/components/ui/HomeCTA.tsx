      ...
      <div className="max-w-2xl mx-auto text-center">
        <div className="relative rounded-3xl overflow-hidden border border-amber-500/20 bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-transparent p-12 md:p-16">
          ...
          <div className="relative z-10">
            ...
            {user ? (
              <>
                <h2 className="text-4xl md:text-5xl font-bold text-stone-900 dark:text-white mb-4 leading-tight">
                  어서오세요!<br />오늘도 맛있는 하루
                </h2>
                <p className="text-stone-500 dark:text-white/50 text-base mb-8 leading-relaxed">
                  마켓, 미디어, 커뮤니티에서<br />
                  새로운 푸드 경험을 시작해보세요.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link
                    href="/market"
                    className="px-10 py-4 rounded-full border border-black/15 dark:border-white/15 text-stone-700 dark:text-white hover:bg-black/8 dark:hover:bg-white/8 transition-all duration-200"
                  >
                    마켓 둘러보기
                  </Link>
                </div>
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  {isLoading ? (
                    <div className="h-14 w-64 rounded-full bg-black/5 dark:bg-white/5 animate-pulse mx-auto" />
                  ) : (
                    <>
                      <Link
                        href="/auth/signup"
