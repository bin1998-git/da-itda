  ...
  return (
    <>
      <button
        onClick={handleOpen}
        title="신고하기"
        className={`inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1.5 rounded-lg border border-rose-500/25 text-rose-400/80 hover:text-rose-500 hover:border-rose-500/50 hover:bg-rose-500/5 transition ${className}`}
      >
        🚨 신고
      </button>
