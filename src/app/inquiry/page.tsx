        ...
        <div className="max-w-3xl mx-auto px-6 py-10 relative">
          <div className="flex items-end justify-between flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-3xl font-bold text-white">나의 문의 내역</h1>
              <p className="text-white/40 text-sm mt-1">궁금한 점을 남겨주시면 빠르게 답변드립니다</p>
            </div>
            <Link
              href="/inquiry/write"
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        {inquiries.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 gap-4">
            ...
            <p className="text-white/40 text-sm">문의 내역이 없습니다</p>
            <Link
              href="/inquiry/write"
            ...
            {inquiries.map((q) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/75 font-medium text-sm truncate group-hover:text-white transition">
                    {q.title}
                  </p>
